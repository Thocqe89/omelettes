          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2 text-white">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-8 border border-white/20">
                <span className="text-sm font-medium tracking-wider">{t("premiumCollection") || "PREMIUM COLLECTION"}</span>
              </div>
              ...
              <p className="text-lg text-white/80 mb-8 max-w-xl leading-relaxed">
                {t("intro") || "Omelette's began in Laos with a simple idea: to connect the dream of flight with stunning detail. We craft every airplane model to be a beautiful, tangible piece of aviation history."}
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  {t("viewModels") || "View Models"}<span className="ml-2"><AiOutlineRight size={20} /></span>
                </Button>
              </div>
              ...
              <div className="flex gap-8 mt-12">
                <div>
                  ...
                  <div className="text-sm text-white/60">Collectors</div>
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Discover our premium selection of meticulously crafted aircraft models
            </p>
          </div>
                  ...
                  <CardBody className="p-0">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                        Premium scale model with authentic detailing
                      </p>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              Where to Showcase Your Collection
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Premium aircraft models enhance any environment with sophistication and style
            </p>
          </div>
                ...
                <div className="relative overflow-hidden aspect-video flex-shrink-0">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20">
                    <div className="bg-white/90 backdrop-blur-sm rounded-full p-3 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                      <span className="text-sm font-medium text-gray-700">Click to view</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Each aircraft model comes in our signature premium gift packaging, 
                  making it the perfect present for any occasion. From luxury gift boxes 
                  to personalized cards, we ensure your gift makes a lasting impression.
                </p>
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-green-500"></div>
                    <span className="text-sm text-gray-600 dark:text-gray-300">Premium Gift Box</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-blue-500"></div>
                    <span className="text-sm text-gray-600 dark:text-gray-300">Personalized Card</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-amber-500"></div>
                    <span className="text-sm text-gray-600 dark:text-gray-300">Elegant Packaging</span>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col lg:flex-row h-full bg-white dark:bg-gray-900">
                  ...
                  <div className="lg:w-1/3 h-1/3 lg:h-full bg-white dark:bg-gray-900 border-t lg:border-l border-gray-200 dark:border-gray-800 p-4 md:p-6 lg:p-8 flex flex-col overflow-y-auto">
                    ...
                    <div className="mt-auto pt-4 lg:pt-6 border-t border-gray-200 dark:border-gray-800">
                      <p className="text-gray-500 dark:text-gray-400 text-sm mb-2 lg:mb-3">Other display settings:</p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="relative z-10">
                <Tooltip content="Visit Three Leaves on TikTok" placement="top">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Each model is a testament to precision engineering and artistic excellence. 
                We combine traditional craftsmanship with modern technology to create pieces 
      ...
      <section className="py-24 bg-gradient-to-r from-[#0d7a68] to-[#0a6455] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
            Join collectors worldwide who trust Omelette's for premium aircraft models 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 pt-12 border-t border-white/20">
            <div className="text-center">
              ...
              <div className="text-sm text-white/80 mt-2">Free Shipping</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">✓</div>
              <div className="text-sm text-white/80 mt-2">Authenticity Guarantee</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">✓</div>
              <div className="text-sm text-white/80 mt-2">Secure Payment</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">✓</div>
              <div className="text-sm text-white/80 mt-2">24/7 Support</div>
            </div>
          </div>
        </div>
      </section>
