  ...
  return (
    <DefaultLayout>
      ...
      {/* <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
        ...
        <h1 className ="text-3xl text-[#0d7a68] font-bold text-center">{t("blog")}</h1>
        {/* Step 1 */}
        {/* Step 1 */}
  ...
  <div className="bg-gray-900 p-6 rounded-xl shadow-md flex flex-col gap-6 items-start">
    ...
    <div className="flex gap-6 items-start w-full">
      ...
      <div className="flex-1">
        <h2 className="text-lg font-semibold text-white">Create a new function</h2>
        <p className="text-gray-400 mb-2">The CLI will prompt you to pick a template for your function.</p>
...
<div className="flex flex-col gap-2">
    ...
    {/* Image on bottom */}
    <div data-aos="fade-up-right" className="w-full flex justify-center">
      <Image
    ...
    <div data-aos="fade-up-right" className="w-full flex justify-center">
      ...
      />
          ...
          <div className="bg-gray-900 p-6 rounded-xl shadow-md flex gap-6 items-start">
            ...
            <div className="flex-1">
              <h2 className="text-lg font-semibold text-white">Push to Git to deploy!</h2>
