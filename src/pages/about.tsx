  ...
  <div data-aos="fade-up-right">
    ...
    />
            ...
            <div data-aos="zoom-in">
              <div className="hidden md:block h-80 w-1 bg-[#0d7a68] mx-8"></div>
            </div>
            {/* Company info */}
            <div className="order-2 md:order-none text-left max-w-2xl relative">
              {/* Mobile line */}
              <div className="md:hidden w-full h-1 text-[#0d7a68] my-6"></div>
              {/* <div data-aos="fade-up-right">
    <Image
      src="/image/ol1.png"
      alt="Company Logo"
...
<br></br>
              <div data-aos="fade-down-left">
                <h1 className="text-3xl text-[#0d7a68] font-bold mb-4">{t("title1")}</h1>
              </div>
              ...
              <div data-aos="fade-down-left">
                <h1 className="text-3xl text-[#0d7a68] font-bold mb-4">{t("title2")}</h1>
              </div>
              ...
              <div data-aos="fade-down-left">
                <h1 className="text-3xl text-[#0d7a68] font-bold mb-4">{t("title3")}</h1>
              </div>
              ...
              <div data-aos="fade-down-left">
                <h1 className="text-3xl text-[#0d7a68] font-bold mb-4">{t("title4")}</h1>
              </div>
                ...
                <div data-aos="zoom-out-right">
                  <Card>
                    <div className="bg-[#0d7a68] text-white p-6 rounded-xl shadow-lg">
                      ...
                      <p> Used for the airplane and text, projecting stability, growth, and nature</p>
                    </div>
                  </Card>
                </div>
                {/* Light Green Card */}
                ...
                <div data-aos="zoom-out-left">
                  ...
                  >
                    <div className="bg-[#A3D9A5] text-green-900 p-6 rounded-xl shadow-lg">
                      ...
                      <p>Used for clouds and accents, softening the design and balancing the visual weight</p>
                    </div>
                  </Card>
                </div>
           ...
           <div data-aos="zoom-in">
          <div className=" h-1 w-80 bg-[#0d7a68] mx-8"></div>
        </div>
