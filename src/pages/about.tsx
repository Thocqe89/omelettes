  ...
  return (
    <DefaultLayout>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0d7a68] via-[#0a6455] to-[#083d33] dark:from-[#0a6455] dark:via-[#083d33] dark:to-[#05271f] text-white">
          ...
          <div className="absolute inset-0 bg-[url('https://res.cloudinary.com/deahgtn57/image/upload/v1749979209/omelett%27s/public/image/3_b5k3zn.jpg')] bg-cover bg-center mix-blend-overlay opacity-20"></div>
