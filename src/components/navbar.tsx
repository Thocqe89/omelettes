...
export const Navbar = () => {
  ...
  return (
    ...
    >
        ...
        <div className="hidden lg:flex gap-4 justify-start ml-2">
          {siteConfig.navItems.map((item) => (
            <NavbarItem key={item.href}>
              ...
              >
                <div
                  className="hidden md:block h-4 w-1  mr-2"
      ...
      >
          ...
          <div className="flex gap-2">
            <Tooltip content={t("facebook page")}>
              <Button
                ...
                startContent={
                  <FaFacebookF className="text-blue-600" size={22} />
                }
                variant="flat"
              />
            </Tooltip>
          ...
          <NavbarItem>
            <Dropdown backdrop="blur">
              ...
              <DropdownMenu aria-label="Language Selection" variant="faded">
                ...
                <DropdownItem
                  key="la"
                  onPress={() => handleLanguageChange("la")}
                >
                  ລາວ
                </DropdownItem>
                <DropdownItem
        ...
        <Tooltip content={t("anouncement")}>
          <button onClick={onOpen}>
            {" "}
            <BsBookmarkFill
              className="text-default-500 hover:text-[#0d7a68]"
              size={25}
            />
          </button>
        </Tooltip>
      ...
      <NavbarContent
        className="sm:hidden basis-1 pl-4 backdrop-blur-md"
        justify="end"
      >
